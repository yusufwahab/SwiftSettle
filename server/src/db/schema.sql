...
--
-- Every worker account is an admin automatically (no self-service toggle,
-- workers.is_admin already defaults true above). Deliberate simplification
-- for single-tenant demo use — see server/README.md's deviations list for
-- why this wouldn't be right in a real multi-tenant product.
